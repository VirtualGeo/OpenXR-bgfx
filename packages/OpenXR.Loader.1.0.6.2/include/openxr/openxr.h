...
#define XR_CURRENT_API_MAJOR_VERSION 1
#define XR_CURRENT_API_MINOR_VERSION 0
#define XR_CURRENT_API_PATCH_VERSION 6
#define XR_CURRENT_API_VERSION XR_MAKE_VERSION(XR_CURRENT_API_MAJOR_VERSION, XR_CURRENT_API_MINOR_VERSION, XR_CURRENT_API_PATCH_VERSION)
